  ...
  return [
    {
      ...
      target: "defReduction",
      damageType: "All",
      // 스택당 2.01%p — 게임 표기는 2%지만 실측이 2.0100~2.0102%를 요구한다.
      // 치사 풀버프 네 줄(가위 2타 크리 4039 · 3타 비크 8793 · 추가 크리 12941 ·
      // 5체인 스킬 크리 340729)이 암흑 2스택과 3스택으로 갈려 있어서, 스택 수에 비례하는
      // 이 칸 말고는 네 줄을 한꺼번에 맞출 자리가 없다(docs/피해-실측-대조.md).
      value: 0.0201,
