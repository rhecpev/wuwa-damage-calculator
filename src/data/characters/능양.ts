...
const liberationSkillAttacks: Attack[] = [
  ...
  // 5체인 「울려퍼지는 칠성북」 — 돌진 · 사자의 질주 발동 시 200% 응결 피해가 한 번 더.
  // 설명문 수치(공격력 200%로 봄)를 옮긴 고정값이라 스킬 레벨과 무관하다.
  {
    id: "1001803_c5",
    name: "5체인 · 울려퍼지는 칠성북 피해",
    type: "Liberation",
    element: "Glacio",
    scalingStat: "ATK",
    skillLevel: 10,
...
const circuitSkillAttacks: Attack[] = [
  ...
  // 고유 「꾸준한 수행」 — 사자의 길에서 일반 공격 후 3초 내 질주 · 초원을 향해가 한 번 더,
  // 질주 피해량의 150%로 떨어진다(공명 스킬 판정). 배율 = 질주 합계(41.69%×2) × 1.5.
  // DamageList에도 41.69%*2 옆에 125.07%(= 83.38 × 1.5) 엔트리가 따로 있다.
  {
    id: "1001807_p5",
    name: "꾸준한 수행 · 질주 추가 피해",
    type: "Skill",
    element: "Glacio",
    scalingStat: "ATK",
    skillLevel: 10,
    extra: true,
    hits: [
      [1.2507, 1.3533, 1.4559, 1.5993, 1.7019, 1.8198, 1.9839, 2.148, 2.3121, 2.4864],
    ],
  },
];
