...
const liberationSkillAttacks: Attack[] = [
  ...
  // 6체인 「정의의 이행」 — 파천의 뇌격 후 30초간 일반 공격 명중 시 「불길 같은 분노」 공격력 419.59%.
  // 레벨과 무관한 고정값. 일반 공격 한 단마다 1회 · 최대 4회라 필요한 만큼 카드를 담는다.
  {
    id: "1001503_c6",
    name: "6체인 · 불길 같은 분노 피해",
    type: "Liberation",
    damageBonusType: "Skill", // 「해당 피해는 공명 스킬 피해로 적용된다」
    element: "Electro",
    scalingStat: "ATK",
    skillLevel: 10,
    resonanceChain: 6,
    hits: [
      [4.1959, 4.1959, 4.1959, 4.1959, 4.1959, 4.1959, 4.1959, 4.1959, 4.1959, 4.1959],
    ],
  },
];
...
//   (피해는 공명 해방 공격 1001503_c6로 반영 — 아래는 원래 메모)
