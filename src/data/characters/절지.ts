...
const liberationSkillAttacks: Attack[] = [
  ...
  // 5체인 「경영위치」 — 재두루미 3마리를 소환할 때마다 1마리가 더 나와 재두루미 피해량의 140%를 준다(일반 공격 판정).
  // DamageList에 32.8% 옆에 45.92%(= 32.8 × 1.4)가 따로 있다. 재두루미 3장마다 이 카드를 1장 담는다.
  {
    id: "1002203_c5",
    name: "5체인 · 추가 재두루미 피해",
    type: "Liberation",
    damageBonusType: "Basic", // 「해당 피해는 일반 공격 피해로 적용된다」
    element: "Glacio",
    scalingStat: "ATK",
    skillLevel: 10,
    resonanceChain: 5,
    hits: [
      [0.4592, 0.49686, 0.53452, 0.5873, 0.62496, 0.66822, 0.72856, 0.78876, 0.84896, 0.91294],
    ],
  },
];
...
const circuitSkillAttacks: Attack[] = [
  ...
  // 6체인 「전이모사」 — 천재의 붓놀림 · 궁극 · 천재의 붓놀림을 쓸 때마다 흰두루미 1마리가
  // 「천재의 붓놀림 피해량의 120%」를 준다(일반 공격 판정). 어느 붓놀림이든 기준은 천재의 붓놀림 배율이다.
  // 붓놀림 카드 1장마다 이 카드를 1장 담는다.
  {
    id: "1002207_c6",
    name: "6체인 · 흰두루미 피해",
    type: "Skill",
    ...
    resonanceChain: 6,
    hits: [
      [1.8, 1.9476, 2.0952, 2.30184, 2.44944, 2.61924, 2.8554, 3.09156, 3.32772, 3.57864],
    ],
  },
];
