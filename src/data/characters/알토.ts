...
const passiveBuffs: CharacterBuffTemplate[] = [
  ...
  {
    // 3체인 — 「안개」를 통과할 때 총알 2개가 더 생겨 「총 일반 공격 또는 공중 공격
    // 피해량의 50%에 해당하는 피해」를 준다. 그 공격의 피해에 비례하므로
    // 배율을 1.5배로 키우는 것과 같다(계수 × (1 + 0.5) = amplify 0.5).
    label: "3체인 · 안개 통과 추가 총알 (일반 · 공중 공격 배율 상승)",
    target: "motionValue",
    damageType: "All",
    attackIds: [
      "1001001_1", // 일반 공격 1단
    ...
    value: 0.5, // 피해량의 50%가 더 붙는다
    modifier: "amplify",
    uptime: "active",
    scope: "self",
    resonanceChain: 3,
    condition: "그 공격이 「안개」를 통과할 때만",
  },
  {
    label: "4체인 · 안개탄 피해",
    target: "damageBonus",
  ...
  // 담아 둔 사이클의 버프 열쇠가 배열 순번이라(character:<id>:<순번>), 해방 자리에
